Redmine::Plugin.register :redmine_agile do
  ...
  permission :agile, { :agile => [:index, :backlogs] }, :public => true
  menu :project_menu, :backlogs, { :controller => 'agile', :action => 'backlogs' }, :caption => 'Agile', :after => :issues, :param => :project_id
end
